...
Outputs:
    ...
    FILES : <COUNTRY>_errors_<method>.csv, <COUNTRY>_latent_space_pca_coords.csv, <COUNTRY>_latent_space.png
...
def test_country(country: str, method: str, tr: int, vr: int, latent: bool):
    print(f"\n==============================")
    ...
    # Split dataset
    # -----------------------------
    (Xc_tr, _), (_, _), (Xc_te, Xk_te) = timeseries_seq_split(Xc, Xk, tr/100, vr/100)
