...
The system consumes Cloudflare Radar API telemetry (L3/L7 traffic, bot activity, attack indicators) to detect anomalies such as DDoS attacks, outages, routing irregularities, and botnet behavior in real-time.
Provides both:
...
## Model Details
1. Hybrid loss function with individual weights:
...
### 1. Installation
    ...
    Run the following commands in $PROJECT_ROOT which is ./ml-anomdetect
